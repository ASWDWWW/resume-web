...
**Project-experience rating: 1.0 / 10** (Minimal)
...
Bare-metal or RTOS firmware, bootloaders, flashing, hardware registers, certification.

## What you did on TREI that maps here

No firmware was written. Wearable vendors own their firmware. TREI stores observations after Spike.

## How that experience applies to this job

Does not apply, except that you designed deletion/erasure of vendor-sourced health data, which firmware teams sometimes ignore at the cloud layer.

## Evidence from this repository

- External-health erasure ledger and disconnect/erase APIs
- Zero firmware artifacts

## Strengths you can claim honestly

Cloud-side device lifecycle (connect, pull, erase).
...
No meaningful firmware experience in this project.
