...
**Project-experience rating: 5.0 / 10** (Partial)
...
Multi-deployment technical strategy, plays, reusable assets, influence across customers and core product.

## What you did on TREI that maps here

You helped set patterns (server-owned projections, custody contracts, fail-closed vendors) that *could* become plays. You have not reused them across many customers or set org-wide FDE strategy.

## How that experience applies to this job

Staff is a leverage title. One deep clinic build is necessary but not sufficient.

## Evidence from this repository

- Reusable platform spine and written architecture
- Single-tenant clinic focus

## Strengths you can claim honestly

You think in boundaries that scale to more clinics later.

## Gaps a hiring manager will still probe

Staff-level scope, communication to execs at multiple accounts, playbooks used by other FDEs.

## How to talk about it

Do not apply to Staff FDE as a first FDE role. Mention the patterns as growth trajectory.

## Bottom line

Too senior as a target. Use as a north star, not a current claim.
