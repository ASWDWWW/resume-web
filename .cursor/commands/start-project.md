...
Read `ops/CONTROL-CENTER.md`, `ops/profile/PROJECT-PROFILE.md`, and `ops/integrations/ROUTING.md` first.
...
6. Update the control center and the matching source of truth.
7. Report built, tested, blocked, and optional items.

If the user named a product after this command, use that product. Otherwise ask which product before touching another repository.
