...
> This score measures how strongly *this repository* maps to a typical **Machine Learning Engineer** hiring bar. It is not years of experience, a compensation band, or a prediction that you would receive an offer.

## What this role is hired to do

ML Engineers train, evaluate, and deploy models: data pipelines, feature stores, training jobs, and inference services.
...
## How that work maps to Machine Learning Engineer

No datasets, no training, no models. Reports and KPIs are aggregations, not ML.
...
Do not claim ML engineering.

## How to talk about this

- If asked about AI/ML, point at the unimplemented estimate-assist idea and the structured WO/parts data that could become training labels later.

## Repo pointers

- `dev/docs/IMPLEMENTATION_PLAN.md` v3 AI estimate assist (idea only)
