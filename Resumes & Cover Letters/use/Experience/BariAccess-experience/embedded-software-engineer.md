...
**Project-experience rating: 1.4 / 10** (Minimal)
...
C/C++/RTOS, MCUs, drivers, timing, hardware bring-up, constrained memory.

## What you did on TREI that maps here

TREI talks to wearables only through Spike cloud APIs. There is no firmware, no MCU, no BLE stack of your own. Phone microphone/WebRTC is application-level, not embedded.

## How that experience applies to this job

Almost nothing maps. At most: you consumed device-originated time series (sleep, steps, HRV) after a vendor normalized them.
...
You understand device data as untrusted evidence with consent and erasure.

## Gaps a hiring manager will still probe

The entire embedded skill set.

## How to talk about it

Do not apply. If a connected-device company wants cloud+app, use Connected-Device Software Engineer instead.

## Bottom line

This project does not qualify you as an embedded engineer.
