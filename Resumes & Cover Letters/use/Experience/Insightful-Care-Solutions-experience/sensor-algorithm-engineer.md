...
Sensor fusion, filtering, calibration, DSP on IMU/camera/bio-signals.

## What you have done in this project

No sensors, no signal processing.

## How that work applies to Sensor Algorithm Engineer

None. Telepsychiatry is clinical, not sensor-based, in this codebase.
