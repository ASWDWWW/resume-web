...
**0 / 10 — No relevant experience**

Do not claim this title from this project.
...
Payment rails, processors, idempotent capture/refund, reconciliation, PCI scope reduction, webhooks from Stripe/Adyen.

## What you have done in this project

No Stripe or processor integration. Cards are mentioned in copy only.

## How that work applies to Payments Infrastructure Engineer

None. Booking/payment is delegated to ChARM Health.

## Gaps versus a typical hiring bar

Entire payments stack missing.

## How to talk about it

Do not claim this title. If asked how money works, say the EHR owns checkout.
